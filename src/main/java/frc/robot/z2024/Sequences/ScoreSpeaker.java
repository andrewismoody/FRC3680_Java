...
public class ScoreSpeaker extends AutoSequence {
  ...
  public void Initialize() {
    ...
    var pose_align1_coral = new ActionPose(Group.Align, Location.Speaker.getValue(), 1, Position.Trough.getValue(), Action.Pickup, null);
    var pose_pickup1_coral = new ActionPose(Group.Pickup, Location.Speaker.getValue(), 1, Position.Trough.getValue(), Action.Pickup, null);
