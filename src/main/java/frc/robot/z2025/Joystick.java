...
public class Joystick {
  public static void InitializeButtonMappings(GameController m_controller,
    ...
    m_controller.RegisterBinaryButtonConsumer(ButtonName.RightButton, elevator.AddButtonMappedPose(new ActionPose("any", "any", -1, "trough", "any", null)));
    m_controller.RegisterBinaryButtonConsumer(ButtonName.LeftButton, elevator.AddButtonMappedPose(new ActionPose("score", "any", -1, "lower", "any", null)));
    m_controller.RegisterBinaryButtonConsumer(ButtonName.TopButton, elevator.AddButtonMappedPose(new ActionPose("score", "any", -1, "middle", "any", null)));
    ...
    m_controller.RegisterBinaryButtonConsumer(ButtonName.Select, elevator.AddButtonMappedPose(new ActionPose("any", "any", -1, "trough", "any", null)));
